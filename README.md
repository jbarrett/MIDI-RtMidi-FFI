...
Perl bindings for [Gary P. Scavone's RtMidi library](https://caml.music.mcgill.ca/~gary/rtmidi/), realtime MIDI input/output across Linux, Macintosh OS X, and Windows.
